...
| G08 | Moving MMA (stock-like) | Open Sell for the phone (Good): note MMA 400.00 and range 280–520. Publish a listing at 280 → MMA barely rises. Complete a sale at a high price → MMA falls by a margin. Repeat listing/buy cycles and confirm the MMA oscillates and the range follows it. | MMA visibly moves in the right direction and magnitude; rejected prices never move it; only completed sales (not authorizations) move it down. | NOT RUN |
...
| 0:25–1:05 | Simulation: 200 rejected, 550 rejected, 350 published against MMA 400 | “The MMA baseline comes from seeded sales and then moves like a stock: accepted listings push it up, completed sales push it down — barely at the low end of the range, by a bounded margin at the high end. Out-of-range listings are rejected automatically; sellers cannot enter their own MMA.” |
